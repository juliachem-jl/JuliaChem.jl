...
Updated build instructions and example scripts/inputs will be added. If you cannot get the project to build, please submit and issue and we will try to help as soon as we can. 
